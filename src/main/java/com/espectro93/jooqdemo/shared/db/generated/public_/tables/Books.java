...
public class Books extends TableImpl<BooksRecord> {
     ...
     */
    public final TableField<BooksRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.books.creation_date</code>.
     */
    public final TableField<BooksRecord, OffsetDateTime> CREATION_DATE = createField(DSL.name("creation_date"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false), this, "");
    ...
    /**
     * The column <code>public.books.content</code>.
     */
    public final TableField<BooksRecord, String> CONTENT = createField(DSL.name("content"), SQLDataType.CLOB.nullable(false), this, "");
